...
let songIndex = 0;
let audioElement = new Audio('songs/bhajan/1.mp3');
let masterPlay = document.getElementById('masterPlay');
let myProgressBar = document.getElementById('myProgressBar');
let songItems = Array.from(document.getElementsByClassName('songItem'));

let songs = [{
        songName: "Atma-Rama-Ananda-Ramana",
        filePath: "songs/bhajan/1.mp3",
        coverPath: "cover/krishna.jpg",
        songDuration: "03:34"
    },
    {
        songName: "Hanuman-Chalisa-Hariharan",
        filePath: "songs/bhajan/2.mp3",
        coverPath: "cover/krishna.jpg",
        songDuration: "04:15"
    }, {
        songName: "Kausalya-Dashrath-Ke-Nandan",
        filePath: "songs/bhajan/3.mp3",
        coverPath: "cover/krishna.jpg",
        songDuration: "03:24"
    }, {
        songName: "O-Kanha-Ab-Toh-Murli",
        filePath: "songs/bhajan/4.mp3",
        coverPath: "cover/krishna.jpg",
        songDuration: "03:20"
    },
]
...
audioElement.addEventListener('timeupdate', () => {
    ...
    if (myProgressBar.value == 100) {
        ...
        makeAllPlays();
        audioElement.src = `songs/bhajan/${songIndex+1}.mp3`;
